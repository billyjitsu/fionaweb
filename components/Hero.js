 ...
 */
  ...
  return (
    <section className="hero">
      <div className="">
        <div className="relative flex w-full h-screen content-center items-center justify-center md:h-screen z-10 bg-nfbGreen">
          ...
          <div className="container relative mx-auto p-16 md:p-0">
            <div className="flex flex-wrap items-center ">
              <div className="w-full md:max-w-lg mt-10 px-4 ml-auto mr-auto text-center">
                <Image src={beezImg} alt="beezImg" />
                <div className="">
                  <h1 className="text-white font-bold text-3xl leading-tighter tracking-tighter md:text-4xl">
                    Web3 Helping Puerto Rico
                  </h1>
                  <p className="mt-4 mb-5 text-md font-bold  text-white md:text-lg">
                    A collection of unique animated bees from the community
                    artists at 1Hive, Agave, BrightID, GUStakes, TEC,
                    Shapeshift, xDai punks and Gitcoin
                  </p>
                ...
                <div>
                  ...
                  <div className="flex flex-col items-center font-bold text-black space-y-2 mb-14 lg:-mb-0">
                    {!loading && !nftMinted && (
                      <>
                        <div>
                          <h3 className="text-sm">Choose your amount</h3>
                        </div>
                        <input
                          type="number"
                          name="tokenID"
                    ...
                    <div className="pt-10">
                      <a
                        href={`https://nfbeezweb-roan.vercel.app/`}
                        rel={"noreferrer"}
                        target="_blank"
                        className="text-lg text-decoration-line: underline text-gray-700"
                      >
